...
impl AspectRatioChoice {
    ...
    pub fn calculate_width(&self, height: u32, custom_ratio: f32) -> u32 {
        let raw_w = match self {
            AspectRatioChoice::TrueStretch145 => {
                let mut w = ((height as f64) * 1.45).round() as u32 + 2;
                if w % 2 != 0 {
                    w += 1;
                }
                return w;
...
pub fn get_presets() -> Vec<ResolutionPreset> {
    vec![
        ResolutionPreset {
            ...
            true_stretch_w: 2090,
            true_stretch_h: 1440,
            true_stretch_ratio: 2090.0 / 1440.0,
            classic_4_3_w: 1920,
            classic_4_3_h: 1440,
            description: "Best for 27\" 1440p gaming monitors. 2090x1440 passes the 1.45 letterbox block natively.",
        },
        ResolutionPreset {
            name: "FHD (1080p)",
            native_w: 1920,
            ...
            true_stretch_w: 1569,
            true_stretch_h: 1080,
            true_stretch_ratio: 1569.0 / 1080.0,
            classic_4_3_w: 1440,
            classic_4_3_h: 1080,
            description: "Standard 1080p competitive preset. 1569x1080 gives wide models with zero black bars.",
        },
        ResolutionPreset {
            name: "HD (720p)",
            native_w: 1280,
            ...
            true_stretch_w: 1044,
            true_stretch_h: 720,
            true_stretch_ratio: 1044.0 / 720.0,
            classic_4_3_w: 960,
            classic_4_3_h: 720,
        ...
        ResolutionPreset {
            ...
            true_stretch_w: 3132,
            true_stretch_h: 2160,
            true_stretch_ratio: 3132.0 / 2160.0,
            classic_4_3_w: 2880,
            classic_4_3_h: 2160,
...
mod tests {
    ...
    fn test_1_45_resolution_calculations() {
        assert_eq!(calculate_1_45_for_height(720), 1046);
        assert_eq!(calculate_1_45_for_height(1080), 1568);
        assert_eq!(calculate_1_45_for_height(1440), 2090);
        assert_eq!(calculate_1_45_for_height(2160), 3134);

        // Verify all computed resolutions strictly satisfy the 1.45 aspect ratio threshold
        for h in [720, 1080, 1440, 2160] {
            ...
            assert_eq!(w % 2, 0, "Width {} must be an even number", w);
        }
    }
