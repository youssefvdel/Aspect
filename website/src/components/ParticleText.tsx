...
const ParticleText: React.FC<ParticleTextProps> = ({
  ...
  useEffect(() => {
    ...
    const sampleText = async () => {
      ...
      const lineHeight = resolvedSize * 1.16;
      ...
      const textHeight = Math.max(1, Math.ceil((lines.length - 1) * lineHeight + ascent + descent));
      ...
      lines.forEach((line, i) => {
        offCtx.fillText(line, centerX, padding + ascent + i * lineHeight);
      });
